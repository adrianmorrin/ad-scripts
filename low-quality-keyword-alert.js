 ...
 *
 * Version: 1.0
 * DONT FORGET to edit email_addresses , qs_threshold (low value) , label_keywords (true if you want to auto label low keywords ) and put name of label as LOW_QS_LABEL_NAME
 * Set PAUSE_KEYWORDS to true if you want them auto paused
 **/
...
var EMAIL_ADDRESSES = ["alice@example.com", "bob@example.com"];
// The address or addresses that will be emailed a list of low QS keywords
// eg ["alice@example.com", "bob@example.com"] or ["eve@example.org"]
